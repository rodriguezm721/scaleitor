            ...
            <form class="row g-3" method="POST" action="{{ route('clientes.store') }}">
               ...
               <div class="col-md-4">
                  <div class="form-floating mb-3">
                     <input name="nom_cliente" type="text" value="{{ old('nom_cliente')}}" class="form-control" id="floatingPassword"
               ...
               <div class="col-md-4">
                  <div class="form-floating mb-3">
                     <input name="cargo" type="text" value="{{ old('cargo')}}" class="form-control" id="floatingPassword"
               ...
               <div class="col-md-4">
                  <div class="form-floating mb-3">
                     <input name="empresa" type="text" value="{{ old('empresa')}}" class="form-control" id="floatingPassword"
                        placeholder="Monto">
